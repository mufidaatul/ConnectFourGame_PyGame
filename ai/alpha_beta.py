...
def alpha_beta(board, depth, alpha, beta, maximizing_player, player_id):
    ...
    # Order moves for better pruning (center columns first)
    ...
    if maximizing_player:
        ...
        for col in valid_moves:
            ...
            eval_score, _ = alpha_beta(board, depth - 1, alpha, beta, False, player_id)
            board.undo_move(col)
        ...
        for col in valid_moves:
            ...
            eval_score, _ = alpha_beta(board, depth - 1, alpha, beta, True, player_id)
            board.undo_move(col)
